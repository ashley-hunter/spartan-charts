                ...
                @if (iconTemplate()?.template; as template) {
                  ...
                  >
                    @if (item.type === 'line') {
                      ...
                      <!-- Pie wedge icon -->
                      <path
                        [attr.d]="'M ' + (iconSize() / 2) + ' ' + (iconSize() / 2) + ' L ' + iconSize() + ' ' + (iconSize() / 2) + ' A ' + (iconSize() / 2) + ' ' + (iconSize() / 2) + ' 0 0 1 ' + (iconSize() / 2) + ' ' + iconSize() + ' Z'"
                        [attr.fill]="item.color"
                      />
...
export class SpnLegend {
  ...
  readonly verticalAlign = input<VerticalAlign>('middle');
  readonly iconSize = input(14, { transform: numberAttribute });
  readonly iconType = input<'line' | 'rect'>('line');
  ...
  onItemClick(item: LegendItem): void {
    // TODO: Implement legend item click to toggle series visibility
