...
import { ShadcnRadialExampleComponent } from '../examples/radial-shadcn/shadcn-radial.example';

interface RadialCard {
  variant: string;
  title: string;
}
...
@Component({
  selector: 'app-radial-shadcn',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ShadcnRadialExampleComponent],
  template: `
        ...
        @for (card of cards; track card.variant) {
          <div class="card">
            ...
            <div class="card-content centered-content">
              <app-shadcn-radial #ex [variant]="card.variant" />
            </div>
  ...
  styles: [
    `
      ...
      .card-content app-shadcn-radial { display: block; width: 100%; max-width: 250px; font-size: 12px; }
      ...
      .shadcn-scope ::ng-deep .spn-shadcn-tooltip .indicator.dot { width: 0.625rem; height: 0.625rem; border-radius: 2px; flex-shrink: 0; }
...
export class RadialShadcnComponent {
  protected readonly drawer = inject(CodeDrawerService);
  protected readonly cards: RadialCard[] = [
    { variant: 'simple', title: 'Radial Chart' },
    { variant: 'label', title: 'Radial Chart - Label' },
    { variant: 'grid', title: 'Radial Chart - Grid' },
    { variant: 'text', title: 'Radial Chart - Text' },
    { variant: 'stacked', title: 'Radial Chart - Stacked' },
    { variant: 'shape', title: 'Radial Chart - Shape' },
  ];
}
