...
import { ShadcnLineExampleComponent } from '../examples/line-shadcn/shadcn-line.example';

/** Faithful replicas of the shadcn/ui line charts, built with spartan-charts. */
@Component({
  selector: 'app-line-shadcn',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ShadcnLineExampleComponent],
  template: `
      ...
      <div class="mx-auto grid max-w-6xl gap-x-6 gap-y-12 pt-10 md:grid-cols-2 xl:grid-cols-3 items-start">
        <div class="card">
          ...
          <div class="card-content">
            <app-shadcn-line #ex0 variant="default" />
          </div>
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">Line Chart - Linear</div>
            <div class="card-description">January - June 2024</div>
          </div>
          <div class="card-content">
            <app-shadcn-line #ex1 variant="linear" />
          </div>
          <div class="card-footer">
            <div class="footer-grid">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">Line Chart - Multiple</div>
            <div class="card-description">January - June 2024</div>
          </div>
          <div class="card-content">
            <app-shadcn-line #ex2 variant="multiple" />
          </div>
          <div class="card-footer">
            <div class="footer-grid">
              <div class="footer-trend">Trending up by 5.2% this month</div>
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">Line Chart - Dots</div>
            <div class="card-description">January - June 2024</div>
          </div>
          <div class="card-content">
            <app-shadcn-line #ex3 variant="dots" />
          </div>
          <div class="card-footer">
            <div class="footer-grid">
              <div class="footer-trend">Trending up by 5.2% this month</div>
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">Line Chart - Label</div>
            <div class="card-description">January - June 2024</div>
          </div>
          <div class="card-content">
            <app-shadcn-line #ex4 variant="label" />
          </div>
          <div class="card-footer">
            <div class="footer-grid">
              <div class="footer-trend">Trending up by 5.2% this month</div>
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">Line Chart - Step</div>
            <div class="card-description">January - June 2024</div>
          </div>
          <div class="card-content">
            <app-shadcn-line #ex5 variant="step" />
          </div>
          <div class="card-footer">
            <div class="footer-grid">
              <div class="footer-trend">Trending up by 5.2% this month</div>
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">Line Chart - Interactive</div>
            <div class="card-description">April - June 2024</div>
          </div>
          <div class="card-content">
            <app-shadcn-line #ex6 variant="interactive" />
          </div>
          <div class="card-footer">
            <div class="footer-grid">
              <div class="footer-trend">Trending up by 5.2% this month</div>
              <div class="footer-sub">Showing total visitors for the last 3 months</div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="card-title">Line Chart - Custom Label</div>
            <div class="card-description">January - June 2024</div>
          </div>
          <div class="card-content">
            <app-shadcn-line #ex7 variant="custom-label" />
          </div>
          <div class="card-footer">
            <div class="footer-grid">
              <div class="footer-trend">Trending up by 5.2% this month</div>
  ...
  styles: [
    `
      ...
      .shadcn-scope ::ng-deep .spn-shadcn-tooltip .indicator.line { width: 0.25rem; align-self: stretch; border-radius: 2px; }
...
export class LineShadcnComponent {
